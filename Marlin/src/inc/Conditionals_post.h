...
#if HAS_TEMPERATURE && ANY(HAS_MARLINUI_MENU, HAS_DWIN_E3V2, HAS_DGUS_LCD_CLASSIC, E3S1PRO_RTS)
 ...
 */
  ...
  #if ANY(HAS_MARLINUI_MENU, EXTENSIBLE_UI, DWIN_LCD_PROUI, DWIN_CREALITY_LCD_JYERSUI, E3S1PRO_RTS) || ALL(EMERGENCY_PARSER, HOST_PROMPT_SUPPORT)
...
#endif
#if ANY(HAS_BEEPER, USE_MARLINUI_BUZZER, E3S1PRO_RTS)
  #define HAS_SOUND 1
#endif
