...
#if ANY(HAS_DISPLAY, HAS_LCDPRINT, E3S1PRO_RTS)
  #define HAS_UTF8_UTILS 1
#endif

#if ANY(HAS_DISPLAY, HAS_DWIN_E3V2, E3S1PRO_RTS)
 ...
 */
  ...
  #define GRID_USED_POINTS_X bedlevel.max_points.x
  #define GRID_USED_POINTS_Y bedlevel.max_points.y
