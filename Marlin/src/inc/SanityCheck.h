...
#elif ENABLED(AUTO_BED_LEVELING_LINEAR) && !(WITHIN(GRID_MIN, 2, 255) && WITHIN(GRID_MAX, 2, 255))
  #error "GRID_MAX_POINTS_[XY] must be between 2 and 255 with AUTO_BED_LEVELING_LINEAR."
#elif ENABLED(AUTO_BED_LEVELING_BILINEAR) && !(WITHIN(GRID_MIN, 3, 255) && WITHIN(GRID_MAX, 3, 255))
